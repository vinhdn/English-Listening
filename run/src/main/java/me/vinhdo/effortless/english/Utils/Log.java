...
public class Log {
	 ...
	 */
	public static String LOGTAG = "Effortless";
	...
	public static void i(String msg, Object... args) {
		try {
			...
			android.util.Log.e(LOGTAG, "tutela.Log", e);
	...
	public static void d(String msg, Object... args) {
		try {
			if (LOGD) 
				android.util.Log.d(LOGTAG, String.format(msg, args));
		} catch (MissingFormatArgumentException e) {
			android.util.Log.e(LOGTAG, "tutela.Log", e);
	...
	public static void e(String msg, Object... args) {
		try {
				android.util.Log.e(LOGTAG, String.format(msg, args));
		} catch (MissingFormatArgumentException e) {
			android.util.Log.e(LOGTAG, "tutelae.Log", e);
