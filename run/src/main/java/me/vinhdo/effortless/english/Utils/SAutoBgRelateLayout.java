package me.vinhdo.effortless.english.Utils;
 ...
 * @author vinh
 */
public class SAutoBgRelateLayout extends RelativeLayout {

	private final static int COLOR_FILTER = Color.GRAY;

	public SAutoBgRelateLayout(Context context) {
		super(context);
	}

	public SAutoBgRelateLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public SAutoBgRelateLayout(Context context, AttributeSet attrs, int defStyle) {
