...
public class Constants {
    public static String BASE = "http://128.199.69.38/elistenaz/";
    public static String DANHMUC = BASE + "danhmuc/getmenu/";
    public static String MENU = BASE + "menu/getsubmenu/";
    public static String SUBMENU = BASE  + "submenu/getlession/";
